...
use CommandsPlus\Commands\Moderator\{BurnCommand, FlyCommand, ClearinventoryCommand, ExtCommand, FreezeCommand, InvseeCommand, KickallCommand, MuteCommand, SocialspyCommand, UnfreezeCommand};
